...
import { NoteListFilters, NoteListFiltersKeys, Tag, Note } from "../../entities/model";
...
const NotesList: FC<NoteListProps> = (props: NoteListProps) => {
    ...
    function updateFilters(name: NoteListFiltersKeys, value: NoteListFilters[NoteListFiltersKeys]) {
                ...
                <Row className="mb-4">
                    ...
                    <Col>
                        <Form.Group controlId="tags">
                            ...
                            <ReactSelect
                                isMulti
                                value={filters.selectedTags.map(({ label, id }) => ({
                                    label,
                                    value: id,
                                }))}
                                onChange={(tags) =>
